...
Os bugs são rastreados como [issues](https://github.com/Strongreen-Company/Anchor_upload_automation/issues) no GitHub, crie um problema e
...
As sugestões de melhorias são rastreadas como [issues](https://github.com/Strongreen-Company/Anchor_upload_automation/issues) no
...
- Abra um [pull request](https://github.com/Strongreen-Company/Anchor_upload_automation/pulls).
